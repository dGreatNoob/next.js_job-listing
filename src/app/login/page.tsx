...
export default function LoginPage() {
  ...
  return (
    <div className=" min-h-screen bg-white flex flex-col lg:flex-row relative">
      ...
      {/* Right Section */}
      <div className="w-full lg:w-1/2 flex flex-col p-12 justify-center">
        ...
        <div className="max-w-md mx-auto w-full items-center">
          <h1 className="text-3xl font-extrabold mb-8 font-clash-display flex justify-center">Welcome Back, Dude</h1>
          <Button 
            variant="outline" 
          ...
          <div className="text-center text-gray-500 mb-4">Or login with email</div>
          <form>
            <div className="mb-4">
